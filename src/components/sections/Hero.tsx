    ...
    <section ref={sectionRef} className="scroll-animation relative">
      ...
      >
        ...
        >
          ...
          <p className="max-w-[46ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
            {profile.tagline} Scroll to run a full systems diagnostic — Generative
            AI, real-time computer vision, and end-to-end ML pipelines.
          </p>
        </div>
        ...
        >
          ...
          <p className="max-w-[36ch] font-mono text-[11px] uppercase tracking-[0.22em] text-zinc-400">
            Scalable AI systems, engineered end to end.
          </p>
        </div>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <figcaption className="mt-3 font-mono text-[11px] tracking-tight text-zinc-400">
                  {d.detail}
                </figcaption>
              </figure>
            </div>
          ...
          {DIALOGUES.map((d) => {
            ...
            return (
              ...
              >
                ...
                <figcaption className="mt-2 font-mono text-[10px] tracking-tight text-zinc-400">
                  {d.detail}
                </figcaption>
              </figure>
            );
